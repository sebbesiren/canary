...
GameStore.Categories = {
	...
	},
	{
		...
		offers = {
			...
			{
				name = "Strike Enchantment",
				price = 25,
				count = 1,
				itemtype = Concoction.Ids.StrikeEnhancement,
				description = "Concoction",
				type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
			},
			{
				...
				price = 25,
				count = 1,
				itemtype = Concoction.Ids.CharmUpgrade,
				description = "Concoction",
				type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
			},
			{
				...
				price = 50,
				count = 1,
				itemtype = Concoction.Ids.BestiaryBetterment,
				description = "Concoction",
				type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
			},
			{
				...
				price = 50,
				count = 1,
				itemtype = Concoction.Ids.WealthDuplex,
				description = "Concoction",
				type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
			},
		},
