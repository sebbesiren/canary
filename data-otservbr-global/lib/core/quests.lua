	...
	Quests = {
		...
		[11] = {
			...
			missions = {
				...
				[89] = {
					name = "Custom Task: Claustrophobic Inferno",
					storageId = 65000 + 44, -- KILLSSTORAGE_BASE + id
					missionId = 10600, -- For mission tracking
					startValue = 0,
					endValue = 2,
					states = {
						[0] = function(player)
				...
				[90] = {
					name = "Custom Task: Rotten Wasteland",
					storageId = 65000 + 45, -- KILLSSTORAGE_BASE + id
					missionId = 10601, -- For mission tracking
					startValue = 0,
					endValue = 2,
					states = {
						[0] = function(player)
				...
				[91] = {
					name = "Custom Task: Furious Crater",
					storageId = 65000 + 46, -- KILLSSTORAGE_BASE + id
					missionId = 10602, -- For mission tracking
					startValue = 0,
					endValue = 2,
					states = {
						[0] = function(player)
				...
				[92] = {
					name = "Custom Task: Sparkling Pools",
					storageId = 65000 + 47, -- KILLSSTORAGE_BASE + id
					missionId = 10603, -- For mission tracking
					startValue = 0,
					endValue = 2,
					states = {
						[0] = function(player)
				...
				[93] = {
					name = "Custom Task: Monster Graveyard",
					storageId = 65000 + 48, -- KILLSSTORAGE_BASE + id
					missionId = 10604, -- For mission tracking
					startValue = 0,
					endValue = 2,
					states = {
						[0] = function(player)
				...
				[94] = {
					name = "Custom Task: Crystal Enigma",
					storageId = 65000 + 49, -- KILLSSTORAGE_BASE + id
					missionId = 10605, -- For mission tracking
					startValue = 0,
					endValue = 2,
					states = {
						[0] = function(player)
				...
				[104] = {
					name = "Custom Task: Cobra bastion",
					storageId = 65000 + 59, -- KILLSSTORAGE_BASE + id
					missionId = 10615, -- For mission tracking
					startValue = 0,
					endValue = 2,
					states = {
						[0] = function(player)
				...
				[105] = {
					name = "Custom Task: Nimmersatt Dragons",
					storageId = 65000 + 60, -- KILLSSTORAGE_BASE + id
					missionId = 10616, -- For mission tracking
					startValue = 0,
					endValue = 2,
					states = {
						[0] = function(player)
				...
				[110] = {
					name = "Custom Task: Falcon bastion",
					storageId = 65000 + 65, -- KILLSSTORAGE_BASE + id
					missionId = 10621, -- For mission tracking
					startValue = 0,
					endValue = 2,
					states = {
						[0] = function(player)
