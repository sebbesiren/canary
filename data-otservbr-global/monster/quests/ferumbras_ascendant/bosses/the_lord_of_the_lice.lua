...
monster.attacks = {
	{ name = "melee", interval = 2000, chance = 100,  minDamage = -120, maxDamage = -600, skill = 100, attack = 100, condition = { type = CONDITION_POISON, totalDamage = 100, interval = 4000 } },
