...
monster.attacks = {
	{ name = "melee", interval = 2000, chance = 100, minDamage = -675, maxDamage = -1200 },
	{ name = "combat", interval = 3100, chance = 40, type = COMBAT_FIREDAMAGE, minDamage = -500, maxDamage = -800, length = 5, effect = CONST_ME_SMOKE, target = false },
