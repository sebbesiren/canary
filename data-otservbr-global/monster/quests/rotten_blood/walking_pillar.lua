...
monster.loot = {
	...
	{ name = "yellow darklight matter", chance = 5354, maxCount = 2 },
	{ name = "magma clump", chance = 11440, maxCount = 2 },
	...
	{ name = "strange helmet", chance = 11001, maxCount = 2 },
	{ name = "fire sword", chance = 8347, maxCount = 2 },
	{ name = "ultimate mana potion", chance = 9687, maxCount = 3 },
	{ name = "blue gem", chance = 5868, maxCount = 2 },
	{ name = "magma legs", chance = 14497, maxCount = 2 },
	{ name = "white gem", chance = 9936, maxCount = 2 },
