...
monster.attacks = {
	...
	{ name = "combat", interval = 2300, chance = 25, type = COMBAT_PHYSICALDAMAGE, minDamage = -375, maxDamage = -392, range = 7, shootEffect = CONST_ANI_THROWINGKNIFE, target = true },
	{ name = "combat", interval = 2600, chance = 30, type = COMBAT_DEATHDAMAGE, minDamage = -386, maxDamage = -480, range = 2, shootEffect = CONST_ANI_SUDDENDEATH, target = true },
	{ name = "combat", interval = 2900, chance = 25, type = COMBAT_PHYSICALDAMAGE, minDamage = -60, maxDamage = -140, range = 1, radius = 4, effect = CONST_ME_EXPLOSIONAREA, target = false },
	{ name = "combat", interval = 3200, chance = 30, type = COMBAT_ENERGYDAMAGE, minDamage = -311, maxDamage = -400, length = 8, spread = 3, effect = CONST_ME_ENERGYHIT, target = false },
}
