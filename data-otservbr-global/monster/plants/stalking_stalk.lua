...
monster.attacks = {
	{ name = "melee", interval = 2000, chance = 100, minDamage = 0, maxDamage = -1000, effect = CONST_ME_CARNIPHILA },
	...
	{ name = "poison chain", interval = 2000, chance = 15, minDamage = -750, maxDamage = -900, range = 7 },
}
