...
monster.attacks = {
	...
	{ name = "combat", interval = 2000, chance = 10, type = COMBAT_EARTHDAMAGE, minDamage = -1000, maxDamage = -1200, length = 5, spread = 5, effect = CONST_ME_GREEN_RINGS, target = false },
	{ name = "combat", interval = 4000, chance = 15, type = COMBAT_ICEDAMAGE, minDamage = -800, maxDamage = -1000, radius = 5, effect = CONST_ME_ICETORNADO, target = false },
	{ name = "combat", interval = 2000, chance = 15, type = COMBAT_ICEDAMAGE, minDamage = -480, maxDamage = -700, range = 7, radius = 5, shootEffect = CONST_ANI_SNOWBALL, effect = CONST_ME_ICEATTACK, target = true },
	{ name = "combat", interval = 3000, chance = 15, type = COMBAT_PHYSICALDAMAGE, minDamage = -950, maxDamage = -1200, range = 7, shootEffect = CONST_ANI_HUNTINGSPEAR, effect = CONST_ME_DRAWBLOOD, target = true },
