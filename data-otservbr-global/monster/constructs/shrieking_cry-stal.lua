...
monster.attacks = {
	...
	{ name = "energy chain", interval = 2000, chance = 20, minDamage = -750, maxDamage = -1400, range = 3, target = true },
	{ name = "combat", interval = 3000, chance = 30, type = COMBAT_ENERGYDAMAGE, minDamage = -1000, maxDamage = -1200, length = 5, spread = 5, effect = CONST_ME_SOUND_PURPLE, target = false },
