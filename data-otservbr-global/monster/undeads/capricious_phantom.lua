...
monster.attacks = {
	...
	{ name = "combat", interval = 3000, chance = 15, type = COMBAT_EARTHDAMAGE, minDamage = -850, maxDamage = -1200, range = 7, radius = 3, shootEffect = CONST_ANI_POISONARROW, effect = CONST_ME_GREEN_RINGS, target = true },
	...
	{ name = "ice chain", interval = 2000, chance = 15, minDamage = -1000, maxDamage = -1200, range = 7 },
}
