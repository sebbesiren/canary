...
monster.loot = {
	...
	{ name = "falcon battleaxe", chance = 1000, maxCount = 1 },
	{ name = "falcon longsword", chance = 1000, maxCount = 1 },
	{ name = "falcon mace", chance = 1000, maxCount = 1 },
	{ name = "grant of arms", chance = 1000, maxCount = 1 },
	{ name = "falcon bow", chance = 1000, maxCount = 1 },
	{ name = "falcon circlet", chance = 1000, maxCount = 1 },
	{ name = "falcon coif", chance = 1000, maxCount = 1 },
	{ name = "falcon rod", chance = 1000, maxCount = 1 },
	{ name = "falcon wand", chance = 1000, maxCount = 1 },
	{ name = "falcon shield", chance = 1000, maxCount = 1 },
	{ name = "falcon greaves", chance = 1000, maxCount = 1 },
	{ name = "falcon plate", chance = 1000, maxCount = 1 },
	...
	{ name = "midnight sarong", chance = 1000 },
	{ name = "midnight tunic", chance = 1000 },
	{ name = "feverbloom boots", chance = 1000 },
	{ id = 39234, chance = 1000 }, -- enchanted turtle amulet
