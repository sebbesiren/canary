...
monster.attacks = {
	...
	{ name = "combat", interval = 2500, chance = 30, type = COMBAT_FIREDAMAGE, minDamage = -150, maxDamage = -450, range = 6, effect = CONST_ME_FIREATTACK, target = true },
	{ name = "combat", interval = 3000, chance = 30, type = COMBAT_FIREDAMAGE, minDamage = -200, maxDamage = -450, range = 6, radius = 2, effect = CONST_ME_FIREAREA, target = true },
}
