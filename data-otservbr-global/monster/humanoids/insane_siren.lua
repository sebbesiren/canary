...
monster.attacks = {
	...
	{ name = "combat", interval = 2900, chance = 17, type = COMBAT_FIREDAMAGE, minDamage = -100, maxDamage = -300, range = 7, shootEffect = CONST_ANI_FIRE, target = false },
	...
	{ name = "combat", interval = 3500, chance = 17, type = COMBAT_FIREDAMAGE, minDamage = -100, maxDamage = -300, range = 6, effect = CONST_ME_FIREATTACK, target = true },
