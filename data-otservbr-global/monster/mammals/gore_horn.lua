...
monster.attacks = {
	...
	{ name = "combat", interval = 4100, chance = 15, type = COMBAT_PHYSICALDAMAGE, minDamage = -400, maxDamage = -600, radius = 7, effect = CONST_ME_EXPLOSIONAREA, target = false },
