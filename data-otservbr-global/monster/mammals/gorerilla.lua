...
monster.attacks = {
	...
	{ name = "combat", interval = 3100, chance = 35, type = COMBAT_FIREDAMAGE, minDamage = -400, maxDamage = -750, range = 7, radius = 3, shootEffect = CONST_ANI_FIRE, effect = CONST_ME_FIREATTACK, target = true },
	{ name = "gorerilla large ring", interval = 3500, chance = 35, minDamage = -600, maxDamage = -750 },
	{ name = "gorerilla small ring", interval = 3800, chance = 20, minDamage = -600, maxDamage = -750 },
}
