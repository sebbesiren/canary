...
monster.attacks = {
	...
	{ name = "speed", interval = 2000, chance = 25, speedChange = -200, range = 7, radius = 4, shootEffect = CONST_ANI_POISON, effect = CONST_ME_GREEN_RINGS, target = true, duration = 15000 },
